...
public class FlameOnPower extends ActiveCooldownPower {
    private final int length;
    private final SoundEvent soundEvent;

    public FlameOnPower(PowerType<?> type, PlayerEntity player, int cooldownDuration, HudRender hudRender, int length, SoundEvent soundEvent) {
